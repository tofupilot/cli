...
// Must precede `mod pytest;`: `#[macro_use]` only exposes the macros to
// items declared after it.
#[macro_use]
mod wire;
...
fn build_request(
    ...
    if let Some(version) = super::procedure_version::read_pyproject_version(procedure_dir) {
